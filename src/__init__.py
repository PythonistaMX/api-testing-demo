"""API simple para el manejo de alumnos"""


from apiflask import APIFlask
from src.project.models import db, Alumno, User
from src.project.alumno.blueprints import abc_alumnos
from src.project.auth.blueprints import auth_bp
